...
#use this make file to build so for android only
#dont use this make file to build ios
#Use ndk of version 17(dont use other version!!!)
#replace ndk path below: NDK_BUNDLE=/Users/Shared/Android/sdk/ndk/17.2.4988734 below
...
########## iOS ( dont use this make file to build iOS, ignore this)
...
ifdef ANDROID
	...
	NDK_BUNDLE=/Users/Shared/Android/sdk/ndk/17.2.4988734
